...
$("textarea").each( function (index, currentTextarea) {
  $(currentTextarea).on("input", function () {
    clearTimeout($(this).data('timeout'));
    $(this).data('timeout', setTimeout( function () {
      var text = $(currentTextarea).val();
      console.log(text);
      $(currentTextarea).highlightWithinTextarea({
        highlight: 'a'
      });
  ...
  // var propertiesToCopy = ["font", "height", "width", "background-color", "padding", "margin", "resize", "overflow", "display"];
